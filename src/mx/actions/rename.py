...
class Rename(ActionExecution):
    ...
    def __init__(self, action_id: str, activity_execution: "ActivityExecution"):
        ...
        Relation.semijoin(db=mmdb, rname1=self.action_mmrv, rname2="Rename Action", svar_name=mmrv.rename_action)
        log_table(_logger, table_msg(db=mmdb, variable_name=mmrv.rename_action))
